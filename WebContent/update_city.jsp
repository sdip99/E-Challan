...
<%
	...
	if(id != null) {
		oldName = new CityDAO().getCityById(Integer.parseInt(id)).getName();
			        ...
			        <form action="Controller" method="post">
						<div class="form-group">
							<p>
								...
								<input type="text" class="form-control span12" name="city_name" value="<% out.print(oldName); %>"/>
							</p>
							<input type="submit" name="submit" class="btn btn-primary form-control" value="Update City" name="submit"/>
						</div>
