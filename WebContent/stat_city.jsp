...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>City Statistics : e-Challan System</title>
    ...
    <script type="text/javascript">
        ...
        function handleFilterEvent() {
        	var id = document.getElementsByName("city_id")[0].value;
        	window.location.href = "stat_generic_pie.jsp?type=city&id=" + id;
        }
    </script>
	<script type="text/javascript">
		<%
        ...
        <div class="header">
	        <h1 class="page-title">City Statistics</h1>
	       	<ul class="breadcrumb">
	            ...
	            <li class="active">City Statistics</li>
	        </ul>
        </div>
        <div class="main-content">
			...
			<div class="panel panel-default">
				...
				<div id="widget1container" class="panel-body collapse in">
					...
					<center>Select City to show further details:
						<select name="city_id">
							<%
								for(City c : city) {
