...
<div class="sidebar-nav">
   	<ul>
		...
		<li><a href="#" data-target=".challan-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-arrow-circle-right"></i> Manage Challan<i class="fa fa-collapse"></i></a></li>
	    <li>
