...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>Change Password : e-Challan System</title>
     ...
     <%
			...
			<div class="panel panel-default">
	        	...
	        	<div id="page-stats" class="panel-collapse panel-body collapse in">
	        		<center>Wrong Password..!!! Please Enter Same Password..</center>
	        	</div>
		    </div>
		   <%
					}
			...
			<div class="panel panel-default">
			    <div class="panel-heading no-collapse">Change Password</div>
			        ...
			        <form action="Controller" method="post">
						<div class="form-group">
							...
							<p>
								...
								<input type="password" class="form-control span12" name="new_pass" />
							</p>
							<p>
								<label>Confirm Password: </label>
								<input type="password" class="form-control span12" name="c_pass"/>
							</p>
					
						<div align="center">		
							<input type="submit" name="submit" class="btn btn-primary" value="Change Password" name="submit"/>
